...
var spear_sprite = preload("res://assets/Sprite/Spear.png");
var axe_sprite = preload("res://assets/Sprite/axe.png");
var dagger_sprite = preload("res://assets/Sprite/dagger.png");
