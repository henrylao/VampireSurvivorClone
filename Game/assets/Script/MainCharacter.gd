...
# Preaload
var spear = preload("res://assets/Weapons/Spear.tscn");
var axe = preload("res://assets/Weapons/Axe.tscn")
var dagger = preload("res://assets/Weapons/Dagger.tscn")
...
func death():
	return get_tree().change_scene("res://assets/Menu/Loose.tscn");
